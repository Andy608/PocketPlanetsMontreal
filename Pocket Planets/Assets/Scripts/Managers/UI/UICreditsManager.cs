...
namespace Managers
{
    public class UICreditsManager : ManagerBase<UISettingsManager>
    {
        [SerializeField] private RectTransform creditsData;
        ...
        {
            if (creditsData.gameObject.activeSelf)
            {
                HideSettingsMenu();
            }
            else
        ...
        private IEnumerator HideContainer()
        {
            ...
            creditsData.gameObject.SetActive(false);
            hideContainer = null;
        }
        ...
        private IEnumerator ShowContainer()
        {
            ...
            creditsData.gameObject.SetActive(true);
